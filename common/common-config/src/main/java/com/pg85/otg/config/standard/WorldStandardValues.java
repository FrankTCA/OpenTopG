...
public class WorldStandardValues extends Settings
{
	...
	public static final Setting<Integer>
		...
		WORLD_MIN_Y = intSetting("WorldMinY", Constants.WORLD_DEFAULT_MIN_Y, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y-1),
		WORLD_MAX_Y = intSetting("WorldMaxY", Constants.WORLD_DEFAULT_MAX_Y, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		...
		WATER_LEVEL_MAX = intSetting("WaterLevelMax", 63, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		WATER_LEVEL_MIN = intSetting("WaterLevelMin", Constants.WORLD_DEFAULT_MIN_Y, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		...
		CAVE_MIN_ALTITUDE = intSetting("CaveMinAltitude", 8, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		CAVE_MAX_ALTITUDE = intSetting("CaveMaxAltitude", 128, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		...
		RAVINE_MIN_ALTITUDE = intSetting("RavineMinAltitude", 20, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		RAVINE_MAX_ALTITUDE = intSetting("RavineMaxAltitude", 68, Constants.MIN_POSSIBLE_Y, Constants.MAX_POSSIBLE_Y),
		...
		LOGICAL_HEIGHT = intSetting("LogicalHeight", Constants.WORLD_DEFAULT_TOTAL_HEIGHT, 0, Constants.MAX_POSSIBLE_Y),
	...
	public static final Setting<Boolean>
		...
		OLD_GROUP_RARITY = booleanSetting("OldGroupRarity", false),
		OLD_LAND_RARITY = booleanSetting("OldLandRarity", false),
