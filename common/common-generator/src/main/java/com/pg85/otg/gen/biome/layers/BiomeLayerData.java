...
public class BiomeLayerData {
    ...
    public final ConcurrentHashMap<Integer, List<NewBiomeGroup>> groups = new ConcurrentHashMap<>();
    ...
    public final ConcurrentHashMap<Integer, NewBiomeGroup> groupRegistry = new ConcurrentHashMap<>();
    public final ConcurrentHashMap<Integer, List<BiomeData>> isleBiomesAtDepth = new ConcurrentHashMap<>();
    public final ConcurrentHashMap<Integer, List<BiomeData>> borderBiomesAtDepth = new ConcurrentHashMap<>();
