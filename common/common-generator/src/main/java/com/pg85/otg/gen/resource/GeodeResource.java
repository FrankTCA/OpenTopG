...
public class GeodeResource extends FrequencyResourceBase {
    ...
    private void placeRandomCluster(IWorldGenRegion world, Vec3i vec, OTGDirection dir, Random random) {
        ...
        if (world.getMaterial(x, y, z) == LocalMaterials.AIR) {
            ...
            switch (type) {
                case 0 ->
                        world.setBlock(x, y, z, LocalMaterials.SMALL_AMETHYST_BUD.withProperty(MaterialProperties.DIRECTION, dir));
                case 1 ->
                        world.setBlock(x, y, z, LocalMaterials.MEDIUM_AMETHYST_BUD.withProperty(MaterialProperties.DIRECTION, dir));
                case 2 ->
                        world.setBlock(x, y, z, LocalMaterials.LARGE_AMETHYST_BUD.withProperty(MaterialProperties.DIRECTION, dir));
                case 3 ->
                        world.setBlock(x, y, z, LocalMaterials.AMETHYST_CLUSTER.withProperty(MaterialProperties.DIRECTION, dir));
            }
        }
    }
